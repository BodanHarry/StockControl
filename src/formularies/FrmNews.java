...
public class FrmNews extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(880, 520));
        ...
        jPanelNews.setBackground(new java.awt.Color(255, 255, 255));
        jPanelNews.setForeground(new java.awt.Color(255, 255, 255));
        jPanelNews.setMaximumSize(new java.awt.Dimension(880, 520));
        jPanelNews.setMinimumSize(new java.awt.Dimension(880, 520));
        jPanelNews.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
